...
export const SUBROUTINE_CATALOG: Record<string, SubRoutineDef> = {
  ...
  writing_prompt:         { key: "writing_prompt",         label: "Writing Prompt",                category: "instruction",       description: "Teacher provides a writing prompt — students respond in writing", defaultDurationMin: 10, defaultDurationMax: 25, supports: S(true,true,false,true,true,true),     studentViewDescription: "Respond to the prompt", icon: "PenLine" },
  external_program:       { key: "external_program",       label: "External Program Link",         category: "instruction",       description: "Launch an external platform — BrainPOP, Edpuzzle, Lorespark, Newsela, Khan Academy, etc.", defaultDurationMin: 10, defaultDurationMax: 30, supports: S(false,false,false,false,false,false), studentViewDescription: "Open the linked program", icon: "ExternalLink" },
