...
export const MAIN_BLOCK_CATALOG: Record<string, MainBlockDef> = {
  ...
  // ── Non-Instructional (8) ──────────────────────────────
  break_time: { key: "break_time", label: "Break", category: "non_instructional", defaultColor: "amber", defaultDurationMin: 5, defaultDurationMax: 15, subjectDescription: "", standardsFramework: null, isInstructional: false, nonInstructionalMessage: "Take a break — you've earned it!", icon: "Coffee" },
